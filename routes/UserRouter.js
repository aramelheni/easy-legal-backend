...
const { postSignin, postSignup, getCurrentUser, getUsersApproximately } = require("../controllers/UserController.js");

userRouter.post("/users/signin", postSignin);
userRouter.post("/users/signup", postSignup);
userRouter.get("/users/approximately/:hint", getUsersApproximately);
